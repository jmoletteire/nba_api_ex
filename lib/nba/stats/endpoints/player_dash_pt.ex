defmodule NBA.Stats.PlayerDashPt do
  @moduledoc """
  ...
  @endpoints %{
    passing: "playerdashptpass",
    rebounding: "playerdashptreb",
    defense: "playerdashptshotdefend",
    shooting: "playerdashptshots"
  }
  ...
  def get!(type, params \\ @default, opts \\ []) do
    case get(type, params, opts) do
      {:ok, data} -> data
      {:error, reason} -> raise "Failed to fetch player tracking dashboard data: #{reason}"
    end
  end
end
