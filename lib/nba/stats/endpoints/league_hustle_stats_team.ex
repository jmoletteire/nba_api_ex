defmodule NBA.Stats.LeagueHustleStatsTeam do
  @moduledoc """
  Provides functions to interact with the NBA stats API for league hustle stats (team).
  ...
  @doc """
  Fetches league hustle stats (team) data.
  ...
  - `params`: A keyword list of parameters to filter the data.
    ...
    - `Height`: Team height filter.
      - _Type(s)_: `String`
      - _Example_: `Height: "6-7"`
      - _Default_: `nil`

    - `DraftYear`: Team draft year filter.
      - _Type(s)_: `String`
      - _Example_: `DraftYear: "2015"`
      - _Default_: `nil`

    - `DraftPick`: Team draft pick filter.
      - _Type(s)_: `String`
  ...
  ## Example
      iex> NBA.Stats.LeagueHustleStatsTeam.get(Season: "2024-25", PerMode: "PerGame", SeasonType: "Regular Season")
      {:ok, %{"LeagueHustleStatsTeam" => [%{...}, ...]}}
  """
